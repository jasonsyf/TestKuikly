...
/**
 * Copy nativevue2.js from shared module build output to h5App's static resource directory.
 * This is needed for the webpack dev server to serve the business logic JS.
 */
val copyNativeVue2Js by tasks.registering(Copy::class) {
    from(project.rootDir.resolve("$businessPathName/build/kotlin-webpack/js/developmentExecutable/nativevue2.js"))
    into(project.layout.buildDirectory.dir("processedResources/js/main"))
...
project.afterEvaluate {
    // Ensure nativevue2.js is copied before dev server starts
    tasks.named("jsBrowserDevelopmentRun") {
        dependsOn(copyNativeVue2Js)
    }
