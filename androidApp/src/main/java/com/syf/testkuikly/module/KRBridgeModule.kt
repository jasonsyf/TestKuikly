package com.syf.testkuikly.module
...
import com.syf.testkuikly.KRApplication
...
class KRBridgeModule : KuiklyRenderBaseModule() {
    ...
    private fun openPage(params: String?) {
        ...
        if (url.isNotEmpty()) {
            val intent = Intent(ctx, com.syf.testkuikly.WebViewActivity::class.java)
            intent.putExtra(com.syf.testkuikly.WebViewActivity.EXTRA_URL, url)
            intent.putExtra(com.syf.testkuikly.WebViewActivity.EXTRA_TITLE, title)
